...
class GildedRoseTest extends TestCase
{
    ...
    public function itemsProvider(): array
    {
        return [
            ...
            'Aged Brie before sell in date with maximum quality' => [
                'Aged Brie',
                5,
                50,
                4,
            ...
            'Aged Brie sell in date near maximum quality' => [
                'Aged Brie',
                0,
                49,
                -1,
            ...
            'Aged Brie sell in date with maximum quality' => [
                'Aged Brie',
                0,
                50,
                -1,
            ...
            'Aged Brie after_sell in date with maximum quality' => [
                'Aged Brie',
                -10,
                50,
                -11,
            ...
            'Backstage passes after sell in date' => [
                'Backstage passes to a TAFKAL80ETC concert',
                -5,
                50,
                -6,
            ...
            'Elixir of the Mongoose sell in date' => [
                'Elixir of the Mongoose',
                0,
                10,
                -1,
